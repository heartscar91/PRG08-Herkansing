class Enemy extends gameObject implements Observable {
    ...
    constructor(game : Game, x : number, y : number, height : number, width : number, health : number, power : number, defense : number, movement: number, speed: number) {
        super('enemy');
        this.game = game;
        this.x = x;
        this.y = y;
    ...
    private hit() : void {
        ...
        // let calc = new Utils.Calculator(this.power);
        this.health -= 2;
        this.showHealth();
    }
