class heroFactory extends gameObject implements Observer {

  private equipped: boolean = false;

  constructor(game : Game, name: string, x : number, y : number, height : number, width : number, health : number, power : number, defense : number) {
      super('hero');
      this.game = game;
      this.name = name;
      this.x = x;
  ...
  public static createHero(game : Game, name: string, x : number, y : number, height : number, width : number, health : number, power : number, defense : number) {
